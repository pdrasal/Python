...
animals = pd.read_csv('Bases/measurement_or_fact.tab', header=0,sep='\t')
animals.info()

top_animals=animals[['measurementValue','measurementID', 'occurrenceID']].sort_values(by=["measurementValue"])
